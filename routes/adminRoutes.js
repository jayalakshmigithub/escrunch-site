...
adminRoute.get('/bannerlist', adminController.adminBannerList); // Display banner list
adminRoute.get('/addbanner', adminController.adminAddbanner); // Display banner add page
...
adminRoute.get('/banner/edit', adminController.adminEditBanner); // Display banner edit page
...
adminRoute.get('/deletebanner', adminController.deleteBanner); // Delete a banner
