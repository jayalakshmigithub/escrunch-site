...
adminRoute.get(
  ...
  adminController.adminUsersList
); //Render user's list
adminRoute.post(
  "/blockunblock",
  auth.isAdminAuthorized,
  adminController.adminBlockUnblock
...
adminRoute.get(
  "/adminaddCategory",
  auth.isAdminAuthorized,
  categoryController.adminAddCategoryPage
...
adminRoute.get(
  "/admineditCategory",
  auth.isAdminAuthorized,
  categoryController.adminEditCategoryPage
); //To edit category page of admin
adminRoute.post(
  "/admineditCategory",
  auth.isAdminAuthorized,
  categoryController.adminEditCategory
...
); //Render list of products page
adminRoute.get(
  "/addproduct",
  auth.isAdminAuthorized,
  productController.adminAddProductPage
); // Render add product page
adminRoute.post(
  "/addproduct",
  auth.isAdminAuthorized,
  productUpload.array("file"),
  productController.adminAddProduct
); //To add new product
adminRoute.get(
  "/editproduct",
  auth.isAdminAuthorized,
  productController.adminEditProductPage
); //Render edit product page
adminRoute.post(
  "/editproduct",
  auth.isAdminAuthorized,
  productUpload.array("file"),
  productController.adminEditProduct
); //To edit product
adminRoute.post(
  "/removeimages",
  auth.isAdminAuthorized,
  productController.adminDeleteImage
); //Delete images of product

adminRoute.get(
  "/adminorderlists",
  auth.isAdminAuthorized,
  orderController.adminOrderLists
); //Render order list page
adminRoute.get(
  "/order/edit",
  auth.isAdminAuthorized,
  orderController.adminEditOrderLists
); //To edit order list
adminRoute.post(
  "/admineditorder",
  auth.isAdminAuthorized,
  orderController.adminEditOrderListPost
); //process
...
adminRoute.get(
  "/reports/sales/download/:type",
  auth.isAdminAuthorized,
  adminController.adminDownloadReports
); //To download sales report

adminRoute.get(
  "/bannerlist",
  auth.isAdminAuthorized,
  adminController.adminBannerList
); // Display banner list
adminRoute.get(
  "/addbanner",
  auth.isAdminAuthorized,
  adminController.adminAddbanner
); // Display banner add page
adminRoute.post(
  "/addbanner",
  productUpload.single("images"),
  auth.isAdminAuthorized,
  adminController.adminAddedBanner
); // Add a new banner
adminRoute.get(
  "/banner/edit",
  auth.isAdminAuthorized,
  adminController.adminEditBanner
); // Display banner edit page
adminRoute.post(
  "/editbanner",
  productUpload.single("images"),
  auth.isAdminAuthorized,
  adminController.adminEditedBanner
); // Edit a banner
adminRoute.get(
  "/deletebanner",
  auth.isAdminAuthorized,
