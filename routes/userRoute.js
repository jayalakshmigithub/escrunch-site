...
router.get('/cart/:cartId/product/:productId',auth.isLogin,cartController.removeFromCart);//Remove product from cart
...
router.post('/userprofile',auth.validatePhoneNumber, auth.isLogin, userController.userProfileUpdated);// Update user profile
...
router.post('/addNewAddress', auth.setCacheControl, auth.checkSession, userController.addNewAddress);
